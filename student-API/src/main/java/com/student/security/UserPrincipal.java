...
/**
 * This is the class whose instances will 
 * be returned from our custom UserDetailsService. 
 * Spring Security will use the information 
 * stored in the UserPrincipal object to perform 
