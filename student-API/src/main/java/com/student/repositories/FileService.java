...
public class FileService {
	...
	/**
	 * Get end point at which the file to be store.
	 * Create dir for student if not exists
	 * Endpoint could be remote location 
	 * 
	 * @param baseEntity
	 * @param fileType
	 * @return
...
//	public Files uploadFile(BaseEntity enity, Files file) {
//		String endPoint = getFileEndPoint(enity, file.getFileType());
//		file.setEndPoint(endPoint);
//		return uploadFile(file);
//	}
//	
//	private Files uploadFile(Files files) {
//		File savedFile = null;
//		
//		try {
//			savedFile = new File(files.getEndPoint() + File.separator + files.getName());
...
//		return mFileRepositoy.save(files);
//	}
}
